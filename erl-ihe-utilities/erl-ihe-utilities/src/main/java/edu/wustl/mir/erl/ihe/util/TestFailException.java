...
/**
 * Indicates that one or more Test Requirements were not met.
 */
public class TestFailException extends Exception{
   private static final long serialVersionUID = 1L;
   
   /**
    * @param em message for exception
    */
   public TestFailException(String em) {
      super(em);
   }
   ...
   public TestFailException() {
      super("One or more test failures");
   }
