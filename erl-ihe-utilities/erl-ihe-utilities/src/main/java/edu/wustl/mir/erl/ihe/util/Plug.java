 ...
 * </ul>
 */
public class Plug implements Serializable, UtilProperties {
   ...
   public Plug(Path pathToFile) throws Exception {
      Util.isValidPfn("Plug input file", pathToFile, PfnType.FILE, "r");
      File file = pathToFile.toFile();
      this.strng = FileUtils.readFileToString(file, CHAR_SET_UTF_8);
   }
   ...
   public Plug(File file) throws Exception {
      Util.isValidPfn("Plug input file", file, PfnType.FILE, "r");
      this.strng = FileUtils.readFileToString(file, CHAR_SET_UTF_8);
   }
   ...
   public String get(Path pathToFile, boolean append) throws Exception {
      ...
      FileUtils.writeStringToFile(pathToFile.toFile(), out, CHAR_SET_UTF_8, append);
      return out;
   }
   ...
   public String get(File file, boolean append) throws Exception {
      String out = StrSubstitutor.replace(strng, map);
      FileUtils.writeStringToFile(file, out, CHAR_SET_UTF_8, append);
      return out;
   }
