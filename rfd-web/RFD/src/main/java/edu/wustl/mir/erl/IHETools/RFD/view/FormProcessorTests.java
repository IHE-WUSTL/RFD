...
@ManagedBean
@ViewScoped
public class FormProcessorTests implements Serializable, WSProperties {
   ...
   public void submitRFD_0_10000(ActionEvent event) {
      ...
      pars.add(new LabelValue <>(LABEL_TEST_STEP, (Object) "FP.RFD_0_10000/1"));
      ...
      return;
   } // EO submitRFD_0_10000_FP method
   ...
   public void submitRFD_1_10000(ActionEvent event) {
      ...
      List <LabelValue <String, Object>> pars = new ArrayList <>();
      List <LabelValue <String, Object>> returns = new ArrayList <>();
      pars.add(new LabelValue <>(LABEL_TEST_STEP, (Object) "FP.RFD_1_10000/1"));
      pars.add(new LabelValue <>(LABEL_WSSERVER_URL, (Object) serverURL));
      pars.add(new LabelValue <>(LABEL_FORM_ID, (Object) formID));
      try {
         returns = runTest(pars);
      ...
      return;
   } // EO submitRFD_1_10000_FP method
...
// **********************************************************
   ...
   public void submitHW_1_10000_HWS_I(ActionEvent event) {
      ...
      List <LabelValue <String, Object>> pars = new ArrayList <>();
      List <LabelValue <String, Object>> returns = new ArrayList <>();
      pars.add(new LabelValue <>(LABEL_TEST_STEP, (Object) "FP.HW_1_10000_HWS_I/1"));
      pars.add(new LabelValue <>(LABEL_WSSERVER_URL, (Object) serverURL));
      pars.add(new LabelValue <>(LABEL_FORM_ID, (Object) formID));
      try {
         returns = runTest(pars);
...
// **********************************************************
   ...
   public void submitVRDR_1_10000_MS_VRDR_I(ActionEvent event) {
      ...
      List <LabelValue <String, Object>> pars = new ArrayList <>();
      List <LabelValue <String, Object>> returns = new ArrayList <>();
      pars.add(new LabelValue <>(LABEL_TEST_STEP, (Object) "FP.VRDR_1_10000_MS_VRDR_I/1"));
      pars.add(new LabelValue <>(LABEL_WSSERVER_URL, (Object) serverURL));
      pars.add(new LabelValue <>(LABEL_FORM_ID, (Object) formID));
      try {
         returns = runTest(pars);
...
// **********************************************************
   ...
   public void submitVRDR_1_10000_VRDR_I(ActionEvent event) {
      ...
      List <LabelValue <String, Object>> pars = new ArrayList <>();
      List <LabelValue <String, Object>> returns = new ArrayList <>();
      pars.add(new LabelValue <>(LABEL_TEST_STEP, (Object) "FP.VRDR_1_10000_VRDR_I/1"));
      pars.add(new LabelValue <>(LABEL_WSSERVER_URL, (Object) serverURL));
      pars.add(new LabelValue <>(LABEL_FORM_ID, (Object) formID));
      try {
         returns = runTest(pars);
...
// **********************************************************
   ...
   public void submitBFDR_E_1_10000_LDS_I(ActionEvent event) {
      ...
      List <LabelValue <String, Object>> pars = new ArrayList <>();
      List <LabelValue <String, Object>> returns = new ArrayList <>();
      pars.add(new LabelValue <>(LABEL_TEST_STEP, (Object) "FP.BFDR_E_1_10000_LDS_I/1"));
      pars.add(new LabelValue <>(LABEL_WSSERVER_URL, (Object) serverURL));
      pars.add(new LabelValue <>(LABEL_FORM_ID, (Object) formID));
      try {
         returns = runTest(pars);
