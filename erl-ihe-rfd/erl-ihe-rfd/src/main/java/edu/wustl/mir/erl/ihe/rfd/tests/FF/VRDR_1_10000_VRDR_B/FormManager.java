 ...
 *******************************************************************************/
package edu.wustl.mir.erl.ihe.rfd.tests.FF.VRDR_1_10000_VRDR_B;
...
/**
 * FormManager simulator test for VRDR_1_10000_VRDR_B
 */
public class FormManager extends FormManagerTest {
   private static final long serialVersionUID = 1L;

   private static final String TEST_ID = "VRDR_1_10000_VRDR_B";
   ...
   public RetrieveFormResponseType formManagerRetrieveForm(
      ...
      prepopData: {
         ...
         // TODO Code here to verify that prepopData is valid CDA VRDR Prepop Document
      ...
      ts = TSTStatus.TST_PREPOP_DOB_PASS;
      String dob = vrdr.getDOB().getValue();
      if (dob.equals("19641120") == false)
         ts = TSTStatus.TST_PREPOP_DOB_FAIL;
      wsLog.addStatus(ts);
      valid = ts.getResult().overall(valid);
...
TST_PREPOP_DOB_FAIL(Phase.TST, Result.FAIL, Level.DEBUG,
   "pre-population decedent date of birth is 11/20/1964: FAIL"),

TST_PREPOP_DOB_PASS(Phase.TST, Result.PASS, Level.TRACE,
   "pre-population decedent date of birth is 11/20/1964: PASS"),
