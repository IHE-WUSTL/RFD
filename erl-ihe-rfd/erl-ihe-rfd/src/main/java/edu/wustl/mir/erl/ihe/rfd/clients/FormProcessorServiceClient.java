 ...
 * FormProcessor acting as a server. Client instantiates this client with the
 * endpoint URL of the FormProcessor service and any desired
 ...
 * 
 * <pre>
 * FormProcessorServiceClient service = FormProcessorServiceClient(
 *    &quot;http://somehost:80/FormProcessor&quot;, new AddressingFeature(true, true));
 * FormProcessorPortType port = service.getPort();
 * RetrieveFormResponseType retrieveformResponse = port
 *    .formProcessorRetrieveForm(retrieveFormRequest);
 * </pre>
 */
public class FormProcessorServiceClient {

   private static URL wsdlURL;
   private URL endpointURL;
   private FormProcessorService service;
   private FormProcessorPortType port;
   private BindingProvider bindingProvider;

   static {
      try {
         wsdlURL = new URL("file:../wsdl/RFDFormProcessor.wsdl");
    ...
    * service and others.
    */
   public FormProcessorServiceClient(String endpointURLString,
      WebServiceFeature... features) throws Exception {
      endpointURL = new URL(endpointURLString);
      service = new FormProcessorService(wsdlURL, features);
      port = service.getFormProcessorPortSoap12();
    ...
    */
   public FormProcessorPortType getPort() {
      return port;
   }
