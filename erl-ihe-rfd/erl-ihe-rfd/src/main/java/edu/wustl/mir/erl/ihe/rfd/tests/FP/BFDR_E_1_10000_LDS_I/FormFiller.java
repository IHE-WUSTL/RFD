 ...
 ******************************************************************************/
package edu.wustl.mir.erl.ihe.rfd.tests.FP.BFDR_E_1_10000_LDS_I;
...
/**
 * Client for BFDR_E_1_10000_LDS_I FormFiller testing FormProcessor
 */
public class FormFiller extends ClientTest {

   private static final String TEST_ID = "FP.BFDR_E_1_10000_LDS_I";
   ...
   public List <LabelValue <String, Object>> runTest(
      ...
      try {
         ...
         LoadNameValuePairs.retrieveFormRequest(retrieveFormRequest, wsLog, new LDS());
