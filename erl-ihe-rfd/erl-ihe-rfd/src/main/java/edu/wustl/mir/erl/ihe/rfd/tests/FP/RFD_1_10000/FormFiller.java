...
/**
 * Client for RFD_1_10000 FormFiller testing FormProcessor
 */
public class FormFiller extends ClientTest {

   private static final String TEST_ID = "FP.RFD_1_10000";
   ...
   public List <LabelValue <String, Object>> runTest(
      ...
      try {
         ...
         List<Element> prepopElements = prepopData.getAny();
         prepopElements.add(XmlUtil.strToElement("<RFD><age>" + 
         (rand.nextInt(84) + 1) + "</age></RFD>" ));
         ...
         LoadNameValuePairs.retrieveFormRequest(retrieveFormRequest, wsLog, null);
