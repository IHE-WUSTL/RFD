 ...
 ******************************************************************************/
package edu.wustl.mir.erl.ihe.rfd.tests.FP.HW_1_10000_HWS_I;
...
import edu.wustl.mir.erl.ihe.rfd.clients.FormProcessorServiceClient;
...
/**
 * Client for HW_1_10000_HWS_I Form Filler testing FormProcessor
 */
public class FormFiller extends ClientTest {

   private static final String TEST_ID = "FP.HW_1_10000_HWS_I";
    ...
    */
   public FormFiller() {
      setAction(FormProcessorPortType.class, "formProcessorRetrieveForm");
   }
   ...
   public List <LabelValue <String, Object>> runTest(
      ...
      try {
         ...
         FormProcessorServiceClient service = new FormProcessorServiceClient(url);
         ...
         LoadNameValuePairs.retrieveFormRequest(retrieveFormRequest, wsLog, new HWS());
         
         RetrieveFormResponseType retrieveFormResponse =
            port.formProcessorRetrieveForm(retrieveFormRequest);
