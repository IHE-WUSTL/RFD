 ...
 ******************************************************************************/
package edu.wustl.mir.erl.ihe.rfd.tests.FM.BFDR_E_1_10000_LDS_I;
...
import edu.wustl.mir.erl.ihe.rfd.cda.document.VRDR;
...
public class FormFiller extends ClientTest {
   ...
   private static final String TEST_ID = "FM.BFDR_E_1_10000_LDS_I";
   ...
   public List <LabelValue <String, Object>> runTest(
      ...
      try {
         ...
         LoadNameValuePairs.retrieveFormRequest(retrieveFormRequest, wsLog, new VRDR());
