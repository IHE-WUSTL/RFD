 ...
 *******************************************************************************/
package edu.wustl.mir.erl.ihe.rfd.tests.FF.BFDR_E_1_10000_LDS_A;
...
/**
 * FormManager simulator test for BFDR_E_1_10000_LDS_A
 */
public class FormManager extends FormManagerTest {
   private static final long serialVersionUID = 1L;

   private static final String TEST_ID = "BFDR_E_1_10000_LDS_A";
   ...
   public RetrieveFormResponseType formManagerRetrieveForm(
      ...
      TSTStatus ts = TSTStatus.TST_PREPOP_LDS_PASS;
      prepopData: {
         if (ppd == null) {
            ts = TSTStatus.TST_PREPOP_LDS_FAIL;
            break prepopData;
         }
